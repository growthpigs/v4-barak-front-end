...
interface ThreeQuarterScreenModalProps {
  isOpen: boolean
  onClose: () => void
  title: string
...
const ThreeQuarterScreenModal: React.FC<ThreeQuarterScreenModalProps> = ({ isOpen, onClose, title, children }) => {
        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              height: "75vh", // Three-quarter height
              y,
            }}
          >
            {/* Drag handle */}
            ...
            <div
              ...
              style={{
                height: "calc(75vh - 100px - env(safe-area-inset-bottom, 0px))",
              }}
            >
              {children}
            </div>
...
export default ThreeQuarterScreenModal
